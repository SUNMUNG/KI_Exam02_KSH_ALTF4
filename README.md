...
11/7 기한은 지났지만 , 사망 후 남아있는 풍선을 삭제하는 로직이 핀 연결이 해제되있는것을 확인하여
본인 만족을 위해 v1.3 릴리즈 버전으로 커밋했습니다.
...
### 개요
-	스테이지 진행하며 최종적으로 마지막 위치에 도착하면 클리어되는 게임
-	스테이지 마지막 도착하면 클리어
-	맵에 여러 개의 기믹 오브젝트 존재
...
11/3-11/4 : 맵 구현 정도에 따라 마무리 구현후  UI
